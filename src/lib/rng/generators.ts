...
function t2_<a, b>(genA: Generators<a>, genB: Generators<b>, rng0: Rng.Seed): GenResult<[a, b]> {
...
export function andThen<a, b>(genA: Generators<a>, f: (val: a) => Generators<b>): Generators<b> {
